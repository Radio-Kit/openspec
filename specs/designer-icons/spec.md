# designer-icons Specification

## Purpose

Unify icon resolution across the RadioKit designer and widget renderers through a centralized registry that combines Phosphor Icons (fill weight) and brand logos, eliminating legacy icon pack dependencies.
