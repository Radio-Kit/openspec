# starter-templates-home Specification

## Purpose

The Models tab replaces the legacy interactive demo section with a starter-templates section shown when the user has no paired models, letting users preview bundled templates in the Designer.
