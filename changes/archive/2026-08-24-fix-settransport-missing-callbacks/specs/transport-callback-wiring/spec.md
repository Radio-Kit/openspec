## Purpose
Define the contract for how `DeviceProvider.setTransport()` wires protocol callbacks to the transport instance, ensuring all packet types are routed correctly regardless of which code path is taken.
